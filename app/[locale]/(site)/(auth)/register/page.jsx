    ...
    <div className="w-full space-y-6 text-zinc-400 sm:max-w-md">
        <div className="text-center">
            ...
            <div className="mt-5 space-y-2">
                <h3 className="text-white text-2xl font-bold sm:text-3xl">OneDay Build, Stay DayOne</h3>
                <p className="">Let's start by creating you account</p>
            </div>
        </div>
        <div className=" shadow p-4 py-6  sm:p-6 sm:rounded-lg">
            <div className="w-full flex flex-row gap-4">
                <button className="flex items-center bg-zinc-900 justify-center py-2.5 border border-zinc-600 rounded-lg hover:bg-zinc-700 duration-150 active:bg-zinc-500 w-1/2">
                ...
                <button className=" w-1/2 flex items-center bg-zinc-900 justify-center py-2.5 border border-zinc-600 rounded-lg hover:bg-zinc-700 duration-150 active:bg-zinc-500">
            ...
            <div className="relative mt-10">
                ...
                <p className="inline-block w-fit text-sm bg-black px-2 absolute -top-2 inset-x-0 mx-auto">Or continue with</p>
            </div>
            <form
            ...
            >
                <div className='mt-8 relative'>
                    ...
                    <input
                        ...
                        className="w-full mt-2 py-3 border bg-zinc-900 focus:bg-black border-zinc-700 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow"
                ...
                <div className='mt-4'>
                    ...
                    <input
                        ...
                        className="w-full mt-2 py-3 border bg-zinc-900 focus:bg-black border-zinc-700 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter password"
                    />
                </div>
                <div className='mt-4'>
                    <label className="font-medium">
                ...
                <button
                type="submit"
                    className=" mt-6 w-full rounded-full py-3 text-black font-medium  bg-primary hover:bg-primary/80  border-indigo-500 hover:shadow inline-flex space-x-2 items-center justify-center"
                >
                    Register
                </button>
            </form>
        ...
        <div className="text-center">
        Have an account? <a href={`/${lang}/login`}  className='text-primary hover:text-primary/80 font-bold'>Login here</a>
        </div>
    </div>
</main>
