...
const aside = () => {
  ...
  return (
    <div><div className="flex flex-col items-center h-screen overflow-hidden text-zinc-800 dark:text-zinc-300 bg-white dark:bg-zinc-800 ">
    ...
    <div className="w-full px-2">
       <div className="flex flex-col items-center w-full mt-3 dark:border-t dark:border-zinc-600">
          <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-[#6759FF] hover:text-gray-300" href="#">
          ...
          <a className="flex items-center w-full h-12 px-3 mt-2 text-gray-200 bg-[#6759FF] rounded" href="#">
             <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
       ...
       <div className="flex flex-col items-center w-full mt-2 border-t border-zinc-600">
          <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-[#6759FF] hover:text-gray-300" href="#">
             <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a className="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-[#6759FF] hover:text-gray-300" href="#">
             <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
