    ...
    <div className="w-full space-y-6 text-zinc-400 sm:max-w-md">
        <div className="text-center">
            ...
            <div className="mt-5 space-y-2">
                ...
                <p className="">Don't have an account? <a href={`/${lang}/register`} className="font-medium text-primary hover:text-primary/80">Sign up</a></p>
            </div>
        </div>
            ...
            >
                ...
                <div className='mt-4'>
                    ...
                    <input
                        ...
                        className="w-full py-3 border bg-zinc-900 focus:bg-black border-zinc-700 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter password"
                    />
                </div>
                <button
                type="submit"
        ...
        <div className="text-center">
            <a href={`/${lang}/change`} className="hover:text-primary">Forgot password?</a>
        </div>
    </div>
</main>
