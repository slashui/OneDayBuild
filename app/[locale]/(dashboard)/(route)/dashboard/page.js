    ...
    <div className="max-w-[1200px] w-full flex flex-row justify-center"> 
      <div className="w-2/3 px-4">
        ...
        <div className="w-full pt-1 relative ">
          ...
          <div className="w-full h-[240px] text-white p-6  bg-indigo-500 rounded-3xl mt-4">
              ...
              <div className="flex flex-row">
                <div className=" bg-black my-4 p-2 rounded-full flex flex-row px-4 items-center"><img className="mr-2" src="/icon/github.svg" /> Github</div>
                <div className=" bg-black my-4 p-2 rounded-full flex flex-row px-4 items-center ml-4"><img className="mr-2" src="/icon/discord.svg" /> Discord</div>
              </div>
